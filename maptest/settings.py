...
SECRET_KEY = '63vfc(v3a6m)+$2m^ll(4@%5t_8gj2*u%d$dmh3%n-gkfe%(*o'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ["www.seniorhousingresearcher.com", "localhost"]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'DataSetv2.sqlite'),
    }
}
