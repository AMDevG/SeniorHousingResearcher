...
if settings.DEBUG:
	COMP_TEMPLATE_FILE_PATH = "C:\\Users\\John Berry\\Desktop\\SeniorHousingResearcher\\findComps\\Comp Tables\\compTemplate.xlsx"
...
def createDownload():
	if os.path.exists(DATA_FILE_PATH):
			with open(DATA_FILE_PATH, 'rb') as fh:
...
def write_excel_file(facility_information):
	...
	for key in facility_information:
		...
		target_ws.cell(row = row_counter, column = 10).value = facility_information[key]['distance']
